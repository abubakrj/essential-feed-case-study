...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClinetError() {
    ...
    func test_load_delivarsNoItemsOn200HTTPResponseWithEmptyJSONList() {
        let (sut, client) = makeSUT()
    ...
    func test_load_delivarsItemsOn200HTTPResponseWithJSONList() {
        let (sut, client) = makeSUT()
